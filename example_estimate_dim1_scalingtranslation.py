...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov  7 11:19:57 2017
...
g = group.ScaleTranslation(space)
...
param_transfor_list=np.array([[[scaling_list[i]], [translation_list[i]]] for i in range(nb_data)])
...
fun_op = func_1D.function_1D_scalingtranslation
